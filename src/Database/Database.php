...
class Database
{
	...
	{
		if ($request['sede'] == '0501' || $request['sede'] == '0201' || $request['sede'] == '0155' || $request['sede'] == '0142' || $request['sede'] == '0203' || $request['sede'] == '0204' || $request['sede'] == '0132' || $request['sede'] == '0148' || $request['sede'] == '0115' || $request['sede'] == '0101' || $request['sede'] == '0205'|| $request['sede'] == '0104'|| $request['sede'] == '0133'|| $request['sede'] == '3661') {
